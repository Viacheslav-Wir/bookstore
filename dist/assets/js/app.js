...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  var map;
  var mapContainer = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#hzh-map')[0];
  var mapCenter = {
    lat: 49.8341582,
    lng: 24.0213342
  };
...
/* harmony import */ var foundation_sites_js_foundation_smoothScroll__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! foundation-sites/js/foundation.smoothScroll */ "./node_modules/foundation-sites/js/foundation.smoothScroll.js");
/* harmony import */ var foundation_sites_js_foundation_sticky__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! foundation-sites/js/foundation.sticky */ "./node_modules/foundation-sites/js/foundation.sticky.js");
/* harmony import */ var foundation_sites_js_foundation_tabs__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! foundation-sites/js/foundation.tabs */ "./node_modules/foundation-sites/js/foundation.tabs.js");
/* harmony import */ var foundation_sites_js_foundation_toggler__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! foundation-sites/js/foundation.toggler */ "./node_modules/foundation-sites/js/foundation.toggler.js");
/* harmony import */ var foundation_sites_js_foundation_tooltip__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! foundation-sites/js/foundation.tooltip */ "./node_modules/foundation-sites/js/foundation.tooltip.js");
/* harmony import */ var foundation_sites_js_foundation_responsiveAccordionTabs__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! foundation-sites/js/foundation.responsiveAccordionTabs */ "./node_modules/foundation-sites/js/foundation.responsiveAccordionTabs.js");
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_reveal__WEBPACK_IMPORTED_MODULE_25__["Reveal"], 'Reveal'); // Foundation.plugin(Slider, 'Slider');

foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_smoothScroll__WEBPACK_IMPORTED_MODULE_26__["SmoothScroll"], 'SmoothScroll');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_sticky__WEBPACK_IMPORTED_MODULE_27__["Sticky"], 'Sticky');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_tabs__WEBPACK_IMPORTED_MODULE_28__["Tabs"], 'Tabs');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_toggler__WEBPACK_IMPORTED_MODULE_29__["Toggler"], 'Toggler');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_tooltip__WEBPACK_IMPORTED_MODULE_30__["Tooltip"], 'Tooltip');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_responsiveAccordionTabs__WEBPACK_IMPORTED_MODULE_31__["ResponsiveAccordionTabs"], 'ResponsiveAccordionTabs');
...
(function () {
  ...
  var url_price_min = '../assets/data/price_all_min.json',
  ...
  function generateCatalogPagesData(sortType, url) {
    ...
    xhr.onload = function () {
      ...
      for (var i = 0; i < data.length; i++) {
        if (data[i].price) {
          cartListHTML += cartTmpl.replace(/--title--/ig, data[i].title).replace(/--author--/ig, data[i].author).replace(/--image--/ig, data[i].image).replace(/--price--/ig, data[i].price).replace(/--product-id--/ig, data[i].id);
        } else {
          cartListHTML += cartTmpl.replace(/--title--/ig, data[i].title).replace(/--author--/ig, data[i].author).replace(/--image--/ig, data[i].image).replace(/--price-- грн/ig, '').replace(/--product-id--/ig, data[i].id);
        }
